                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" id="email"
                                            value="{{ old('email', $customer->customer->email ?? '') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="marketing_opt_in" id="marketing_opt_in" class="form-control @error('marketing_opt_in') is-invalid @enderror">
                                            <option value="0" {{ old('marketing_opt_in', $customer->marketing_opt_in) == false ? 'selected' : '' }}>No</option>
                                            <option value="1" {{ old('marketing_opt_in', $customer->marketing_opt_in) == true ? 'selected' : '' }}>Yes</option>
                                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="notes" id="notes" rows="3"
                                          ...
                                          maxlength="1000" placeholder="Any additional notes...">{{ old('notes', $customer->notes) }}</textarea>
