...
<div class="card card-secondary">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div id="thumbnail-upload-status" class="mt-2" style="display:none;">
                        <span class="badge badge-info"><i class="fas fa-spinner fa-spin"></i> Uploading...</span>
                    </div>
    ...
    <div class="card-footer bg-light">
        <small class="text-muted">
            ...
            Images are saved automatically. No need to click Save button.
        </small>
    </div>
</div>
</div>