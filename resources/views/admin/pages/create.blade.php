                ...
                <div class="card">
                    ...
                    <form action="{{ route('admin.pages.store') }}" method="POST" id="pageForm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Content <span class="text-muted">(Editor.js — click + to add blocks)</span></label>
                                <div class="mb-2">
...
class MediaTextTool {
  ...
  _updatePreview() {
    ...
    if (!url) {
      this.nodes.preview.innerHTML = '<span style="color:#999;font-size:13px;">🖼 Preview</span>';
      return;
    }
  ...
  static get sanitize() {
    return {
      text: { br: true, b: true, i: true, u: true, a: { href: true, target: true }, ul: true, ol: true, li: true }
    };
  }
}
...
$(function() {
    window.editor = new EditorJS({
        ...
        data: {
            blocks: [
                { type: 'paragraph', data: { text: 'Start writing your page content here...' } }
            ]
        }
    });
...
$('#pageForm').on('submit', function(e) {
    ...
    window.editor.save().then((outputData) => {
        ...
        btn.prop('disabled', false).html('<i class="fas fa-save"></i> Create Page');
